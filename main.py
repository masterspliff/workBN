...
def run(playwright: Playwright) -> None:
    ...
    page.locator("div:nth-child(3) > .pim-column-actions > .pim-floating-label-input__wrapper > .pim-floating-label-input__data > .pim-floating-label-input__input").fill("senses")
    ...
    page.locator("div:nth-child(4) > .pim-column-actions > .pim-floating-label-input__wrapper > .pim-floating-label-input__data > .pim-floating-label-input__input").fill("box")
    ...
    while True:
        ...
        try:
            next_button = page.get_by_role("button", name="").first
            if next_button:
                next_button.click()
